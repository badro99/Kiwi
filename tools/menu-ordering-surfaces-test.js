...
ok('caisse combines formula stages and regular options', /const groups = itemOptGroups\(item\)/.test(caisse) && /Formule & options/.test(caisse) && /opts,\s*optSig:\s*optSig\(opts\)/.test(caisse));
