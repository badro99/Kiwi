...
const swCacheVer = parseInt((sw.match(/var CACHE = 'kiwi-app-v(\d+)'/) || [])[1] || '0', 10);
ok(swCacheVer >= 370 && !/kiwi-employee-k-/.test(sw), 'the shared PWA cache evicts every legacy employee icon');
