...
const DB = { prepare(text) { return new Statement(text); }, async batch(statements) { return statements.map((s) => s.rows()); } };
...
const base = { action:'save', merchant:'riad-test', clientRef:'staff-ref-0001', roomTypeId:'type-atlas', checkIn:day(5), checkOut:day(7), partySize:2, channel:'booking', status:'confirmed', externalRef:'OTA-4219', customer:{name:'Salma',phone:'0612345678',email:''} };
let controls = 0;
