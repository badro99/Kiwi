...
ok(res.status===200&&body.ok&&puts[0].key.startsWith('media/second-hotel/'),'an owned secondary hotel receives its collision-free R2 prefix');
...
ok(res.status===200&&puts[1].key.startsWith('media/second-hotel/hotel-room/'),'hotel galleries receive a cleanup-safe R2 sub-prefix');
