...
assert.match(sw, /kiwi-app-v339/, 'offline shell generation advanced');
assert.match(caissePwa, /kiwi-sw\.js\?v=339/, 'caisse requests the new worker');
assert.match(dashboardPwa, /kiwi-sw\.js\?v=339/, 'dashboard requests the new worker');
