...
assert.match(sw, /kiwi-app-v338/, 'offline shell generation advanced');
assert.match(caissePwa, /kiwi-sw\.js\?v=338/, 'caisse requests the new worker');
assert.match(dashboardPwa, /kiwi-sw\.js\?v=338/, 'dashboard requests the new worker');
