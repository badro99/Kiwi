...
var CORPUS = [
  ...
  ['quels produits sont en rupture', 'lookup'],
  ...
  ['quels articles sont bientôt épuisés', 'lookup'],
  ['current stock level', 'stock'],
  ['what is out of stock', 'lookup'],
  ...
  ['mes meilleurs clients', 'lookup'],
  ['combien de clients au total', 'clients'],
  ['des clients qui ne reviennent plus', 'lookup'],
  ...
  ["qui travaille aujourd'hui", 'lookup'],
  ...
  ['quel est mon meilleur produit', 'lookup'],
  ['quel serveur vend le plus', 'lookup'],
  ...
  /* ─ lookups : la réponse vit dans un autre module ─ */
  ['mon meilleur vendeur', 'lookup'],
  ['quel plat se vend le mieux', 'lookup'],
  ['quel est l’article qui se vend le moins', 'lookup'],
  ['mes produits les plus vendus', 'lookup'],
  ['quelle boisson se vend le plus', 'lookup'],
  ['top 3 des ventes', 'lookup'],
  ['my worst selling item', 'lookup'],
  ['what sells best', 'lookup'],
  ['best selling product', 'lookup'],
  ['المنتج الأقل مبيعا', 'lookup'],
  ['qui est mon meilleur client', 'lookup'],
  ['who is my best customer', 'lookup'],
  ['mon plus gros client', 'lookup'],
  ['quel client dépense le plus', 'lookup'],
  ['أفضل زبون عندي', 'lookup'],
  ['combien de points a Salma Bennani', 'lookup'],
  ['combien de points il lui reste', 'lookup'],
  ['how many points does this client have', 'lookup'],
  ['كم نقطة عند هذا الزبون', 'lookup'],
  ['quels clients ne sont pas revenus', 'lookup'],
  ['mes clients perdus', 'lookup'],
  ['which customers have not come back', 'lookup'],
  ['qui travaille aujourd’hui', 'lookup'],
  ['qui est de service ce soir', 'lookup'],
  ['who is working today', 'lookup'],
  ['combien j’ai d’employés', 'lookup'],
  ['combien de salariés j’ai', 'lookup'],
  ['how many staff do I have', 'lookup'],
  ['كم عدد الموظفين', 'lookup'],
  ['qui est mon meilleur serveur', 'lookup'],
  ['quels produits sont en rupture', 'lookup'],
  ['quels articles sont en stock bas', 'lookup'],
  ['which items are out of stock', 'lookup'],
  /* ─ les voisins qui gardent leur route ─ */
  ['mes clients les plus fidèles', 'clients'],
  ['combien de clients VIP', 'clients'],
  ['combien j’ai de références', 'stock'],
  ['combien j’ai fait hier', 'day'],
  ['puis-je embaucher un serveur', 'hire'],
  ['combien je gagne', 'profit'],
];
