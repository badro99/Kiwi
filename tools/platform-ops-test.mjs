...
ok(/kiwi-app-v370/.test(sw),'service worker cache was advanced');
ok(/dashboard-pwa\.js\?v=370/.test(pages[0])&&/caisse-pwa\.js\?v=370/.test(pages[1])&&/employee-live\.js\?v=370/.test(pages[2]),'all shells request the current service-worker bootstrap');
