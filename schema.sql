...
-- Operator work records, migration 2026-09-07-operator-workspace.sql.
...
-- ═══════════════════════════════════════════════════════════════════════════
-- KIWI TICKETS · problème → à tester → corrigé et testé
-- ═══════════════════════════════════════════════════════════════════════════
-- Outil interne accessible par son lien. Le numéro est un AUTOINCREMENT afin
-- qu'un ticket supprimé après sa rétention ne rende jamais son numéro au ticket
-- suivant. Les photos vivent dans R2 ; cette table ne garde que leurs clés.
