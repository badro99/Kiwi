...
var SHELL = [
  ...
  '/assets/pressing-dashboard.css?v=5',
  ...
  '/assets/pressing-dashboard.js?v=5',
  '/assets/demoClock.js',
  ...
  '/assets/pressing-caisse.js?v=5',
  '/assets/pressing-caisse.css?v=5',
