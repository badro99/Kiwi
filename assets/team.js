...
(function () {
  ...
  const STR = {
    fr: {
      ...
      placeholder: { firstName: 'Sara', lastName: 'Belkadi', email: 'sara@kiwi.ma', phone: '06… / +33…', address: 'Rue 12, Maarif, Casablanca', cin: 'BK 384721', emergencyName: 'Karim Belkadi', emergencyPhone: '06… / +33…', notes: 'Allergie crustacés · disponibilité étendue le week-end' },
    ...
    en: {
      ...
      placeholder: { firstName: 'Sara', lastName: 'Belkadi', email: 'sara@kiwi.ma', phone: '06… / +33…', address: '12 Rue, Maarif, Casablanca', cin: 'BK 384721', emergencyName: 'Karim Belkadi', emergencyPhone: '06… / +33…', notes: 'Shellfish allergy · extended weekend availability' },
    ...
    ar: {
      ...
      placeholder: { firstName: 'سارة', lastName: 'بلقاضي', email: 'sara@kiwi.ma', phone: '06… / +33…', address: 'شارع 12، المعاريف، الدار البيضاء', cin: 'BK 384721', emergencyName: 'كريم بلقاضي', emergencyPhone: '06… / +33…', notes: 'حساسية من القشريات · توفر موسع نهاية الأسبوع' },
