      ...
      return ({
        fr: {
          ...
          errs:{
            ...
            'rate-limited':'Trop de demandes sur ce domaine dans l’heure — réessayez plus tard.',
            'payload-too-large':'Demande trop volumineuse — allégez-la et réessayez.',
            'attempt-limit':'Cette commande a été relancée trop de fois — clôturez-la ou annulez-la.',
        ...
        en: {
          ...
          errs:{
            ...
            'rate-limited':'Too many requests on this domain this hour — try again later.',
            'payload-too-large':'Request too large — trim it and try again.',
            'attempt-limit':'This command has been retried too many times — close it or cancel it.',
        ...
        ar: {
          ...
          errs:{
            ...
            'rate-limited':'طلبات كثيرة على هذا المجال خلال ساعة — أعد المحاولة لاحقًا.',
            'payload-too-large':'الطلب كبير جدًا — قلّصه ثم أعد المحاولة.',
            'attempt-limit':'أُعيد تشغيل هذا الأمر مرات كثيرة — أغلقه أو ألغِه.',
