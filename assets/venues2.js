 ...
 * — DASHBOARD2 FORK (venues2.js) — adds the HOTEL vertical (Riad Yasmina).
 *   Loaded only by dashboard2.html; dashboard.html keeps venues.js untouched.
 *
 * The merchant account contains 4 venues across 4 verticals
 * (restaurant, boutique, spa, hotel). Switching the venue swaps:
...
(() => {
  ...
  const REAL_VENUES = ['cafeAtlas', 'maisonMansour', 'spaBahia', 'riadYasmina'];
  ...
  const VENUES = {
    cafeAtlas: {
      ...
      siblings: '3 autres emplacements · Casa / Marrakech',
      status: 'En service',
      ice: '0025938400014',
      txCount: 182,
      staffCount: 8,
    ...
    // The hotel vertical — a 24-room riad in the Marrakech médina with its
    // own restaurant + hammam. The capstone venue: F&B and spa charges post
    // to the room folio (see assets/hotel.js — dashboard2-only).
    riadYasmina: {
      id: 'riadYasmina',
      name: 'Riad Yasmina',
      location: 'Médina',
      fullDisplay: 'Riad Yasmina · Médina',
      type: 'hotel',
      typeLabel: 'Riad · 24 chambres',
      siblings: '3 autres emplacements · Casa / Marrakech',
      status: 'En service',
      ice: '0031284700052',
      txCount: 41,
  ...
  const HEADER_SUB = {
    ...
    ar: { cafeAtlas: 'خدمة الغداء جارية', maisonMansour: 'البوتيك مفتوح · 10ص–8م', spaBahia: 'الفضاء مفتوح · الحجوزات جارية', riadYasmina: 'الرياض مفتوح · 7 وصولات متوقعة الليلة', fusion: '3 مواقع نشطة · عرض موحّد' },
  };
  ...
  const MIX_CMI_SAVINGS = {
    ...
    en: {
      ...
      riadYasmina:   '~2,150 MAD this month',
    ...
    ar: {
      ...
      riadYasmina:   '~2 150 درهم هذا الشهر',
  ...
  const BENCH_LABELS = {
    fr: {
      ...
      riadYasmina:   { title: 'Vous vs riads similaires',     sub: '64 riads & maisons d’hôtes · médina de Marrakech' },
    ...
    en: {
      ...
      riadYasmina:   { title: 'You vs similar riads',     sub: '64 riads & guesthouses · Marrakech medina' },
    ...
    ar: {
      ...
      riadYasmina:   { title: 'أنتم مقابل الرياضات المماثلة', sub: '64 رياضًا ودار ضيافة · مدينة مراكش العتيقة' },
  ...
  function renderDropdown() {
    ...
    /* Client account — their switcher lists ONLY their own venues; the demo
     * venues (and the fusion/portfolio view built from them) must never leak
     * in. Either the in-session 0000 flag, or a persisted onboarding
     * (kiwiOnboarded) — a returning client logs in with their own PIN. */
  ...
  const FUSION_TYPE_ICONS = {
    ...
    hotel:      '<path d="M3 21h18"/><path d="M5 21V7a2 2 0 012-2h10a2 2 0 012 2v14"/><path d="M9 9h2M13 9h2M9 13h2M13 13h2"/><path d="M10 21v-3h4v3"/>', // Building/riad
  ...
  const STAFF = {
    ...
    riadYasmina: [
      { id: 'ry01', name: 'Omar Sqalli', role: 'Directeur du riad', department: 'management', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 60, contractHours: 44, avatar: 'OS', status: 'present', clockedInAt: '08:30', shiftsThisMonth: 24, hoursThisMonth: 104.0, tipsThisMonth: 0, salesThisMonth: 0, voids: 0, rating: null },
      { id: 'ry02', name: 'Imane Berrada', role: 'Réceptionniste senior', department: 'accueil', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 32, contractHours: 44, avatar: 'IB', status: 'present', clockedInAt: '07:00', shiftsThisMonth: 22, hoursThisMonth: 96.0, tipsThisMonth: 640, salesThisMonth: 42600, voids: 0, rating: 4.9 },
      { id: 'ry03', name: 'Ayoub Lahlou', role: 'Réceptionniste de nuit', department: 'accueil', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 30, contractHours: 40, avatar: 'AL', status: 'off', clockedInAt: null, shiftsThisMonth: 20, hoursThisMonth: 80.0, tipsThisMonth: 280, salesThisMonth: 18400, voids: 0, rating: 4.6 },
      { id: 'ry04', name: 'Khadija El Amrani', role: 'Gouvernante générale', department: 'menage', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 28, contractHours: 44, avatar: 'KE', status: 'present', clockedInAt: '08:00', shiftsThisMonth: 23, hoursThisMonth: 100.0, tipsThisMonth: 0, salesThisMonth: 0, voids: 0, rating: 4.8 },
      { id: 'ry05', name: 'Naima Bouziane', role: 'Femme de chambre', department: 'menage', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 20, contractHours: 40, avatar: 'NB', status: 'present', clockedInAt: '08:30', shiftsThisMonth: 22, hoursThisMonth: 88.0, tipsThisMonth: 0, salesThisMonth: 0, voids: 0, rating: 4.5 },
      { id: 'ry06', name: 'Fatiha Zerouali', role: 'Femme de chambre', department: 'menage', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 20, contractHours: 40, avatar: 'FZR', status: 'present', clockedInAt: '09:00', shiftsThisMonth: 21, hoursThisMonth: 84.0, tipsThisMonth: 0, salesThisMonth: 0, voids: 0, rating: 4.4 },
      { id: 'ry07', name: 'Hicham Daoudi', role: 'Valet · bagages & patio', department: 'menage', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 18, contractHours: 40, avatar: 'HD', status: 'present', clockedInAt: '09:00', shiftsThisMonth: 22, hoursThisMonth: 88.0, tipsThisMonth: 420, salesThisMonth: 0, voids: 0, rating: null },
      { id: 'ry08', name: 'Driss Benjelloun', role: 'Chef de cuisine', department: 'cuisine', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 42, contractHours: 44, avatar: 'DB', status: 'present', clockedInAt: '10:00', shiftsThisMonth: 23, hoursThisMonth: 98.0, tipsThisMonth: 0, salesThisMonth: 0, voids: 0, rating: null },
      { id: 'ry09', name: 'Meriem Ouazzani', role: 'Cuisinière · petit-déjeuner', department: 'cuisine', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 26, contractHours: 40, avatar: 'MO', status: 'present', clockedInAt: '06:30', shiftsThisMonth: 22, hoursThisMonth: 88.0, tipsThisMonth: 0, salesThisMonth: 0, voids: 0, rating: null },
      { id: 'ry10', name: 'Said Lamrani', role: 'Serveur · restaurant & terrasse', department: 'salle', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 24, contractHours: 44, avatar: 'SL', status: 'present', clockedInAt: '11:00', shiftsThisMonth: 21, hoursThisMonth: 92.0, tipsThisMonth: 1860, salesThisMonth: 31400, voids: 1, rating: 4.7 },
      { id: 'ry11', name: 'Salima Cherkaoui', role: 'Praticienne hammam', department: 'soin', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 34, contractHours: 40, avatar: 'SC', status: 'present', clockedInAt: '10:30', shiftsThisMonth: 21, hoursThisMonth: 84.0, tipsThisMonth: 1620, salesThisMonth: 22800, voids: 0, rating: 4.9 },
      { id: 'ry12', name: 'Latifa Benslimane', role: 'Praticienne · massages', department: 'soin', venue: 'riadYasmina', venueName: 'Riad Yasmina', hourlyRate: 32, contractHours: 40, avatar: 'LBS', status: 'off', clockedInAt: null, shiftsThisMonth: 19, hoursThisMonth: 76.0, tipsThisMonth: 1240, salesThisMonth: 17600, voids: 0, rating: 4.7 },
    ],
  };
  ...
  const EQ_DEPTS = {
    ...
    menage:     { label: 'Ménage',     color: 'var(--warning)'   },
  };
  const EQ_DEPT_ORDER = ['cuisine','salle','caisse','accueil','menage','support','management','soin','vente'];
  ...
  const MENU = {
    ...
    riadYasmina: [
      // Restaurant du riad — carte courte, dîner aux chandelles + terrasse.
      { id: 'ry-r01', name: 'Petit-déjeuner terrasse', category: 'entrees', price: 95, cost: 24, unitsThisMonth: 486, station: 'cuisine-chaude', tags: ['signature'], times: { matin: 486, midi: 0, soir: 0 } },
      { id: 'ry-r02', name: 'Harira du riad', category: 'entrees', price: 40, cost: 7, unitsThisMonth: 168, station: 'cuisine-chaude', tags: [], times: { matin: 0, midi: 62, soir: 106 } },
      { id: 'ry-r03', name: 'Salade marocaine', category: 'entrees', price: 55, cost: 11, unitsThisMonth: 142, station: 'cuisine-froide', tags: ['vegan'], times: { matin: 0, midi: 84, soir: 58 } },
      { id: 'ry-r04', name: 'Tajine poulet citron confit', category: 'tajines', price: 165, cost: 46, unitsThisMonth: 224, station: 'cuisine-chaude', tags: ['signature', 'top'], times: { matin: 0, midi: 88, soir: 136 } },
      { id: 'ry-r05', name: 'Tajine agneau pruneaux', category: 'tajines', price: 210, cost: 72, unitsThisMonth: 118, station: 'cuisine-chaude', tags: ['premium'], times: { matin: 0, midi: 38, soir: 80 } },
      { id: 'ry-r06', name: 'Couscous du vendredi', category: 'couscous', price: 190, cost: 52, unitsThisMonth: 96, station: 'cuisine-chaude', tags: ['signature'], times: { matin: 0, midi: 64, soir: 32 } },
      { id: 'ry-r07', name: 'Pastilla poulet', category: 'pastillas', price: 150, cost: 42, unitsThisMonth: 84, station: 'cuisine-chaude', tags: [], times: { matin: 0, midi: 36, soir: 48 } },
      { id: 'ry-b01', name: 'Thé à la menthe', category: 'boissons', price: 30, cost: 4, unitsThisMonth: 942, station: 'bar', tags: ['signature', 'top'], times: { matin: 286, midi: 312, soir: 344 } },
      { id: 'ry-b02', name: 'Café noir', category: 'boissons', price: 18, cost: 3, unitsThisMonth: 384, station: 'bar', tags: [], times: { matin: 226, midi: 92, soir: 66 } },
      { id: 'ry-b03', name: 'Jus orange pressé', category: 'boissons', price: 40, cost: 10, unitsThisMonth: 318, station: 'bar', tags: [], times: { matin: 184, midi: 86, soir: 48 } },
      { id: 'ry-b04', name: 'Eau minérale 75cl', category: 'boissons', price: 25, cost: 6, unitsThisMonth: 426, station: 'bar', tags: [], times: { matin: 88, midi: 164, soir: 174 } },
      { id: 'ry-d01', name: 'Cornes de gazelle', category: 'desserts', price: 45, cost: 9, unitsThisMonth: 174, station: 'patisserie', tags: ['signature'], times: { matin: 22, midi: 58, soir: 94 } },
      { id: 'ry-d02', name: 'Orange cannelle', category: 'desserts', price: 35, cost: 6, unitsThisMonth: 128, station: 'patisserie', tags: [], times: { matin: 8, midi: 46, soir: 74 } },
      // Hammam & spa du riad — posté directement sur le folio chambre.
      { id: 'ry-s01', name: 'Hammam traditionnel', category: 'soins', price: 280, cost: 42, unitsThisMonth: 96, station: 'hammam', tags: ['signature', 'top'], times: { matin: 22, midi: 34, soir: 40 } },
      { id: 'ry-s02', name: 'Gommage beldi', category: 'soins', price: 250, cost: 34, unitsThisMonth: 58, station: 'hammam', tags: [], times: { matin: 14, midi: 22, soir: 22 } },
      { id: 'ry-s03', name: 'Massage à l’huile d’argan 60min', category: 'soins', price: 450, cost: 62, unitsThisMonth: 64, station: 'cabine-1', tags: ['premium'], times: { matin: 16, midi: 22, soir: 26 } },
      { id: 'ry-s04', name: 'Rituel hammam + massage duo', category: 'soins', price: 980, cost: 138, unitsThisMonth: 26, station: 'hammam', tags: ['premium'], times: { matin: 4, midi: 10, soir: 12 } },
    ],
    spaBahia: [
  ...
  window.KiwiVenue = {
    ...
    getHeroAiRec: id => {
      ...
      // Hotel: the strategic insight is the OTA-commission wedge, not menu
      // margins — always serve the curated hotel rec over the menu engine.
      if (VENUES[v]?.type === 'hotel') {
        const LH = HERO_AI_REC[fusionLang()] || HERO_AI_REC.fr;
        return LH[v] || LH.cafeAtlas;
      }
