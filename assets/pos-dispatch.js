...
(function () {
  ...
  const REGISTRY = {
    ...
    '0000': { id: 'pressing',    file: 'pressing-caisse', rev: '33', label: 'Pressing · Pressing Marshan' },
    ...
    '0017': { id: 'maison',      file: 'pos-maison',      rev: '3', label: 'Art de table & décoration · Vogue Home' },
  };
