...
(function () {
  ...
  const REGISTRY = {
    ...
    '0002': { id: 'boutique',    file: 'pos-boutique',    rev: '17', label: 'Boutique · Maison Mansour' },
    '0003': { id: 'spa',         file: 'pos-spa',         rev: '5', label: 'Spa · Spa Bahia' },
    '0004': { id: 'hotel',       file: 'pos-hotel',       rev: '12', label: 'Hôtel / Riad' },
    ...
    '0017': { id: 'maison',      file: 'pos-maison',      rev: '21', label: 'Maison · Vogue Home' },
  };
