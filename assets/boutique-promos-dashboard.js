...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = `
      ...
      .bpd-empty{max-width:680px;margin:28px auto 0;text-align:center}.bpd-empty>svg{width:31px;height:31px;color:var(--atlas)}.bpd-empty h2{font-size:24px;margin:12px 0 7px}.bpd-empty p{max-width:510px;margin:0 auto;color:var(--n-500);font-size:13.5px;line-height:1.55}.bpd-starters{display:grid;gap:9px;margin-top:22px;text-align:left}.bpd-starter{display:grid;grid-template-columns:1fr auto;gap:3px 12px;padding:14px 16px;border:1px solid var(--line);border-radius:13px;background:var(--paper);cursor:pointer}.bpd-starter b,.bpd-starter span{grid-column:1}.bpd-starter span{font-size:12px;color:var(--n-500)}.bpd-starter svg{grid-column:2;grid-row:1/3;width:16px;color:var(--atlas)}
      ...
      @media(max-width:900px){.bpd-compose{grid-template-columns:1fr}.bpd-preview{position:static}.bpd-scopes{grid-template-columns:repeat(2,1fr)}}`;
