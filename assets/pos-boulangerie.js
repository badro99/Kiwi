    ...
    el.innerHTML = `
      ...
      <div class="bl-tk-lines" id="bl-tk-lines">
        ${state.ticket.length ? state.ticket.map((l, i) => lineRow(l, i)).join('') : `
          <div class="bl-tk-empty" style="display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; padding:32px 14px; gap:8px;">
            ...
            <div style="font-size:12.5px; color:var(--n-500); line-height:1.45;">Touchez khobz, msemen ou croissant, la vente part en deux gestes.</div>
          </div>`}
      </div>
