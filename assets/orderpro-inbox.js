...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      '#kop-root .kop-head{display:flex;align-items:center;gap:14px;padding:18px 22px;border-bottom:1px solid rgba(10,15,13,.08);background:#fff;}',
      '#kop-root .kop-head h2{margin:0;font-size:1.15rem;font-weight:700;letter-spacing:-.01em;}',
      '#kop-root .kop-x{margin-left:auto;width:38px;height:38px;border-radius:11px;border:1px solid rgba(10,15,13,.1);background:#fff;cursor:pointer;display:grid;place-items:center;color:var(--ink,#0A0F0D);}',
      ...
      '#kop-root .kop-card{background:#fff;border:1px solid rgba(10,15,13,.08);border-radius:16px;padding:15px 17px;margin-bottom:11px;box-shadow:0 1px 2px rgba(10,15,13,.04);}',
      ...
      '#kop-root .kop-btn.ghost{background:#fff;border:1px solid rgba(10,15,13,.14);color:rgba(10,15,13,.65);}',
